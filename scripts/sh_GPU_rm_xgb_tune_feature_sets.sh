...
#SBATCH --job-name=rm_xgb_tune
#SBATCH --mail-user=vadibekyan@astro.up.pt
#SBATCH --mail-type=END,FAIL
#SBATCH --output=/projects/F202418352CPCAA1/logs/rm_xgb_tune_%j.out
#SBATCH --error=/projects/F202418352CPCAA1/logs/rm_xgb_tune_%j.err
...
mkdir -p /projects/F202418352CPCAA1/results/xgb_tuning_run_01
