...
#SBATCH --job-name=rm_nested_loo
#SBATCH --mail-user=vadibekyan@astro.up.pt
#SBATCH --mail-type=END,FAIL
#SBATCH --output=/projects/F202418352CPCAA1/logs/rm_nested_loo_%j.out
#SBATCH --error=/projects/F202418352CPCAA1/logs/rm_nested_loo_%j.err
...
mkdir -p /projects/F202418352CPCAA1/results/xgb_nested_loo_run_01

cd /projects/F202418352CPCAA1

python rm_rf/scripts/nested_leave_one_observation_out.py \
